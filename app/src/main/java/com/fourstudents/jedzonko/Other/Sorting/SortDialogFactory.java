...
public class SortDialogFactory {
    ...
    public static AlertDialog getLocalSortDialog(Context context, LayoutInflater inflater, SortProperty sortProperty, SortOrder sortOrder, SortListener sortListener) {
        androidx.appcompat.app.AlertDialog.Builder alertBuilder = new androidx.appcompat.app.AlertDialog.Builder(context);

        alertBuilder.setTitle(R.string.dialog_sort_title);
        final ConstraintLayout layout = (ConstraintLayout) inflater.inflate(R.layout.dialog_sort_local, null);
        alertBuilder.setView(layout);
